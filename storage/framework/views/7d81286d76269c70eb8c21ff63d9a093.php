...
<div
    ...
    <div class="h-full flex items-center">
        ...
        <a href="/admin/dashboard" class="logo -intro-x hidden md:flex xl:w-[180px] block">
            <img alt="AstroGuru image" class="logo__image w-6" src="<?php echo e(asset($logo->value)); ?>"
        ...
        <div class="intro-x dropdown w-8 h-8">
            <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110"
                ...
                <?php if(auth()->user()): ?>
                    <img class="rounded-full" src="<?php echo e(asset(auth()->user()->profile)); ?>"
                        onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Admin Profile" />
                <?php else: ?>
                    <img class="rounded-full" src="<?php echo e(asset('build/assets/images/person.png')); ?>" alt="Admin Profile" />
                <?php endif; ?>
...
<?php endif; ?>
<!-- END: Top Bar -->
<?php /**PATH /home/dqot-astrotalk/htdocs/astrotalk.dqot.solutions/resources/views////layout/components/top-bar.blade.php ENDPATH**/ ?>