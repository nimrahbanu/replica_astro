                ...
                <div class="my-auto">
                    <?php
                        ...
                        $appName = DB::table('systemflag')
                            ...
                            ->first();
                    ?>
                    <img alt="AstroGuru image" class="-intro-x w-1/2 -mt-16" src="<?php echo e(asset($logo->value)); ?>"
                    ...
                    <div class="intro-x mt-8">
                        <form>
                            ...
                            <input id="email" type="text" class="intro-x login__input form-control py-3 px-4 block"
                                placeholder="Email" name="email" value="admin@gmail.com">
                            <div class="text-danger print-email-error-msg mb-2" style="display:none">
                                <ul></ul>
                            </div>
                            <input id="password" type="password" name="password"
                                class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password" value="12345678">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dqot-astrotalk/htdocs/astrotalk.dqot.solutions/resources/views/pages/login.blade.php ENDPATH**/ ?>