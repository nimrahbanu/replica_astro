                ...
                <div class="d-flex align-items-center w-50">
                    ...
                    <a class="navbar-brand" href="<?php echo e(route('front.home')); ?>">
                        <div class="d-flex align-items-center">
                            <img src="<?php echo e(asset($logo->value)); ?>" alt="<?php echo e($appName->value); ?>" class="img-fluid"
                                width="53" height="53">
                            <div class="astroway-logo-ntext ml-2">
                                <span class="astroway-logo-text"><?php echo e($appName->value); ?></span>
                                <span class="astroway-logo-subtext">Talk Anytime Anywhere With Astrologer</span>
                            </div>
                        </div>
                    </a>
                                ...
                                <div class="dropdown ">
                                    <a class="btn dropdown-toggle p-0" role="button" id="dropdownMenuLink"
                                        ...
                                        <?php if(authcheck()['profile']): ?>
                                            <img src="<?php echo e(asset(authcheck()['profile'])); ?>" alt="User"
                                                class="img-fluid">
                                        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /home/dqot-astrotalk/htdocs/astrotalk.dqot.solutions/resources/views/frontend/layout/header.blade.php ENDPATH**/ ?>