...
<div class="ds-head-body">
    ...
    <div class="container-fluid mt-3">
        ...
        <div class="slider">
            ...
            <div class="slide">
                <img src="<?php echo e(asset($banners['bannerImage'])); ?>" alt="" />
            </div>
                ...
                <ul class="list-unstyled d-flex mb-0 px-lg-4 px-xl-5 mx-xl-5 pt-3 pb-lg-3">
                    ...
                    <li class="today-panchang">
                        <a href="<?php echo e(route('front.getPanchang')); ?>">
                            <div class="text-center mb-2 mb-md-0">
                                <div class="icon">
                                    <img src="<?php echo e(asset($panchang['value'])); ?>" alt="" height="55" width="55" />
                                </div>
                    ...
                    <li class="cheating-and-affairs">
                        <a href="<?php echo e(route('front.getkundali')); ?>">
                            <div class="text-center mb-2 mb-md-0">
                                <div class="icon">
                                    <img src="<?php echo e(asset($freekundali['value'])); ?>" alt="" height="55" width="55" />
                                </div>
                    ...
                    <li class="kundali-matching">
                        <a href="<?php echo e(route('front.kundaliMatch')); ?>">
                            <div class="text-center mb-2 mb-md-0">
                                <div class="icon">
                                    <img src="<?php echo e(asset($kundali_matching['value'])); ?>" alt="" height="55" width="55" />
                    ...
                    <li class="Online-Puja">
                        <a href="<?php echo e(route('front.getproducts')); ?>">
                            <div class="text-center mb-2 mb-md-0">
                                <div class="icon">
                                    <img src="<?php echo e(asset($shop['value'])); ?>" alt="" height="55" width="55" />
                    ...
                    <li class="daily-horoscope">
                        <a href="<?php echo e(route('front.horoScope')); ?>">
                            <div class="text-center mb-2 mb-md-0">
                                <div class="icon">
                                    <img src="<?php echo e(asset($daily_horoscope['value'])); ?>" alt="" height="55" width="55" />
                                </div>
                    ...
                    <li class="astroway-blog mr-0">
                        <a href="<?php echo e(route('front.getBlog')); ?>">
                            <div class="text-center mb-2 mb-md-0">
                                <div class="icon">
                                    <img src="<?php echo e(asset($blog['value'])); ?>" alt="" height="55" width="55" />
...
<div class="container mt-5 <?php echo e(empty($liveastro['recordList']) ? 'mb-5' : ''); ?>">
    ...
    <div class="stories-container">
        ...
        <div class="story <?php echo e($story->allStoriesViewed > 0 ? 'viewed' : ''); ?>" data-astrologer-id="<?php echo e($story->astrologerId); ?>" data-astrologer-name="<?php echo e($story->name); ?>" data-astrologer-profile="<?php echo e($story->profileImage); ?>">
            ...
            <img src="<?php echo e(asset($story->profileImage)); ?>" alt="<?php echo e($story->name); ?>" />
            ...
            <div class="col-sm-12">
                <div class="owl-carousel owl-theme owl-blur owl-mobile">
                    ...
                    <div class="item gif-animation-enable mb-3"
                        style="background:url('<?php echo e($live['profileImage'] ? asset($live['profileImage']) : asset('frontend/astrowaycdn/dashaspeaks/web/content/images/user-img-new.png')); ?>')">
                                ...
                                <div class="position-absolute bottom-part w-100 p-2">
                                    <div class="d-flex h-100 align-items-center">
                                        <div
                                            ...
                                            <img src="<?php echo e(asset($live['profileImage'])); ?>" width="38"
                        ...
                        <a href="<?php echo e(route('front.astrologerDetails', ['id' => $astrologer['id']])); ?>">
                            ...
                            <div class="astro-profile">
                                <div>
                                    ...
                                    <img src="<?php echo e(asset($astrologer['profileImage'])); ?>" class="img-fluid"
                                        loading="lazy">
                                    <?php else: ?>
                                    <img src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/images/user-img-new.png')); ?>"
                                        class="img-fluid">
                    ...
                    <a href="<?php echo e($astrologyVideo['youtubeLink']); ?>">
                        <div class="tile">
                            <div
                                ...
                                <img class="youtube-image" src="<?php echo e(asset($astrologyVideo['coverImage'])); ?>"
                                    alt="">
                ...
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item mb-3">
                        <a href="<?php echo e(route('front.getproductDetails', ['id' => $shop['id']])); ?>">
                            <img src="<?php echo e(asset($shop['productImage'])); ?>" alt="<?php echo e($shop['name']); ?>"
            ...
            <div class="col-sm-12">
                <div class="d-flex flex-wrap justify-content-center publishers-list">
                    ...
                    <a href="<?php echo e($astrotalkInNews['link']); ?>" target="_blank">
                        <div class="publisher row-1"><img src="<?php echo e(asset($astrotalkInNews['bannerImage'])); ?>"
                ...
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item mb-3" d-flex>
                        <a href="<?php echo e(route('front.getBlogDetails', ['id' => $blog['id']])); ?>"
                            class="colorblack">
                            <img src="<?php echo e(asset($blog['blogImage'])); ?>" alt="" class="img-fluid"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dqot-astrotalk/htdocs/astrotalk.dqot.solutions/resources/views/frontend/pages/index.blade.php ENDPATH**/ ?>